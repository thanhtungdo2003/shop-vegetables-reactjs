                        ...
                        <div className="user-nav" style={{ margin: "auto 10px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", position: "relative" }}>
                            ...
                            <div className="user-menu-contaner">
                                <div className="user-menu-item">
                                    <User color="rgb(40, 175, 94)" className="user-menu-item-icon" size={24} /><p>Tài khoản</p>
                                </div>
                                <div className="user-menu-item">
                                    <ShoppingBagIcon color="rgb(40, 175, 94)" className="user-menu-item-icon" size={24} /><p>Đơn hàng của bạn</p>
                                </div>
                                <div className="user-menu-item">
                                    <Settings2Icon color="rgb(40, 175, 94)" className="user-menu-item-icon" size={24} /><p>Cài đặt</p>
                                </div>
                                {checkPerm(userData)}
                                            ...
                                            query && (
                                                <>
                                                    <button onClick={() => setQuery("")} className="mr-2" style={{
                                                        ...
                                                        <X color="rgb(82, 203, 84)" size={20} className="text-gray-500 hover:text-gray-700" />
                                                    </button>
                                                    <button onClick={() => search(query)} className="mr-2" style={{
                                                        border: "none", outline: "none", cursor: "pointer", backgroundColor: "transparent",
                                                        width: "24px", height: "24px", margin: "auto 10px"
                                                    }}>
                                                        <SearchCheckIcon color="rgb(94, 194, 79)" size={20} className="text-gray-500 hover:text-gray-700" />
                                                    </button>
                                                </>
                            ...
                            <div className="nav-container">
                                <div className="nav-left">
                                    <ul>
                                        ...
                                        <li><a href="/vegetables-graden/product">SẢN PHẨM</a></li>
                                        <li><a>BLOG</a></li>
                                    </ul>
                                </div>
